  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
        ...
        <a class="navbar-brand" href="#">SedCo </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-2 my-lg-0 search-box">
              ...
              <a href="checkout"><i class="fas fa-shopping-cart fa-2x cartb"><span class="cart"><?php echo $cart_count; ?></span></i></a>
          </div>
      ...
      <?php
            ...
            <li class="navbar-brand dropdown form-inline my-2 my-lg-0 ">
                  ...
                  <div class="dropdown-menufix dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="user_orders.php"><i class="fas fa-cubes usp"></i>My Orders</a>
