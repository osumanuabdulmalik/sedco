...
<main>
	  ...
	  <div class="heading cf">
	    <h1>Review Order</h1>
	    <a href="index.php" class="continue">Place order</a>
	  </div>
	  <div class="cart">
	      ...
	      <div class="infoWrap"> 
	        ...
	        <div class="prodTotal cartSection">
	          <p><?php echo "₵".$product["price"]; ?></p>
	             ...
	             <a href="#" class="remove"><button type='submit' class='remove' style="display: unset;">x</button></a>
	        </div>
	        </form>
	      </div>
	      </li>
	  ...
	  <div class="subtotal cf">
	    <ul>
	      ...
	      <li class="totalRow"><a href="order_confirmation.php" class="btn continue">Place Order</a></li>
	    </ul>
	  </div>
	</div>
