...
<main>
    ...
    <hr>
    <h2 class="text-center">Business Investing</h2>
    <hr>
    ...
    echo'
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          $result = mysqli_query($conn,"SELECT * FROM `bizbooks` WHERE id='1' ");
           ...
           <form method="post" action="">
            ...
            $result = mysqli_query($conn,"SELECT * FROM `bizbooks` WHERE id='2' ");
           while ($row = mysqli_fetch_assoc($result)){
           echo '
            <form method="post" action"">
